...
function (t) {
    ...
    t.fn.TouchSpin = function (i) {
        ...
        return this.each(function () {
            ...
            function p() {
                d(), T = 0, W = "down", b.trigger("touchspin.on.startspin"), b.trigger("touchspin.on.startdownspin"), x = setTimeout(function () {
            ...
            function c() {
                d(), T = 0, W = "up", b.trigger("touchspin.on.startspin"), b.trigger("touchspin.on.startupspin"), _ = setTimeout(function () {
            ...
            ! function () {
                if (!b.data("alreadyinitialized")) {
                    ...
                    "" !== (u = t.extend({}, o, C, (a = {}, t.each(s, function (t, e) {
                        ...
                        }, n(), b.on("keydown.touchspin", function (t) {
...
function (t) {
    ...
    w.prototype = {
        ...
        open: function (i) {
            ...
            if (!1 === i.isObj) {
                ...
                if (!e.isOpen) {
                    ...
                    _("BeforeOpen"), e.st.showCloseBtn && (e.st.closeBtnInside ? (z(l, function (t, e, i, o) {
                    ...
                    return e.isIE7 && (w += " mfp-ie7"), w && e._addClassToMFP(w), e.updateItemHTML(), _("BuildControls"), t("html").css(f), e.bgOverlay.add(e.wrap).prependTo(e.st.prependTo || t(document.body)), e._lastFocusedEl = document.activeElement, setTimeout(function () {
                        e.content ? (e._addClassToMFP(m), e._setFocus()) : e.bgOverlay.addClass(m), o.on("focusin" + u, e._onFocusIn)
                    }, 16), e.isOpen = !0, e.updateSize(d), _(p), i
                }
                e.updateItemHTML()
            }
        },
        close: function () {
            e.isOpen && (_(h), e.isOpen = !1, e.st.removalDelay && !e.isLowIE && e.supportsTransition ? (e._addClassToMFP(f), setTimeout(function () {
                e._close()
        ...
        appendContent: function (t, i) {
            e.content = t, t ? e.st.showCloseBtn && e.st.closeBtnInside && !0 === e.currTemplate[i] ? e.content.find(".mfp-close").length || e.content.append(b()) : e.content = t : e.content = "", _("BeforeAppend"), e.container.addClass("mfp-" + i + "-holder"), e.contentContainer.append(e.content)
        },
        parseEl: function (i) {
            var o, s = e.items[i];
            if (s.tagName ? s = {
        ...
        updateStatus: function (t, o) {
            if (e.preloader) {
                ...
                _("UpdateStatus", s), t = s.status, o = s.text, e.preloader.html(o), e.preloader.find("a").on("click", function (t) {
        ...
        _parseMarkup: function (e, i, o) {
            var s;
            o.data && (i = t.extend(o.data, i)), _(l, [e, i, o]), t.each(i, function (i, o) {
            ...
            getAjax: function (i) {
                ...
                var o = t.extend({
                    ...
                    success: function (o, s, n) {
                        ...
                        _("ParseAjax", r), e.appendContent(t(r.data), I), i.finished = !0, O(), e._setFocus(), setTimeout(function () {
                            e.wrap.addClass(m)
    ...
    t.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            getImage: function (i, o) {
                var s = 0,
                    n = function () {
                        i && (i.img[0].complete ? (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, _("ImageLoadComplete")) : 200 > ++s ? setTimeout(n, 100) : r())
                    },
                    r = function () {
        ...
        jQuery.fn[e] = function (t) {
            return t ? this.bind("resize", function (t, e, i) {
                ...
                return function () {
                    var s = this,
                        n = arguments;
                    o ? clearTimeout(o) : i && t.apply(s, n), o = setTimeout(function () {
